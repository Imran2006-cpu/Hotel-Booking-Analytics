...
-- Business Question:
-- What are the total bookings, cancellations, cancellation rate,
-- and estimated revenue lost due to cancellations?
-- SQL Concepts: Aggregate Functions, CASE, ROUND
SELECT
...
-- Business Question:
-- Compare bookings, cancellations and ADR across hotel types.
SELECT
    hotel,
    COUNT(*) AS total_bookings,
...
-- =========================================================
-- Query 3: Lead Time vs Cancellation Analysis
SELECT
    CASE
...
ORDER BY arrival_date_year, MIN(arrival_date_week_number);
